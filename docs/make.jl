...
makedocs(;
    modules = [CableLineModels],
    authors = "Stefan de Lange <langestefan@msn.com>",
    repo = "https://github.com/langestefan/CableLineModels.jl/blob/{commit}{path}#{line}",
    sitename = "CableLineModels.jl",
    format = Documenter.HTML(;
        canonical = "https://langestefan.github.io/CableLineModels.jl",
    ),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/langestefan/CableLineModels.jl")
